...
<html lang="es">
	...
	<body background="images\webb.png">
		...
		<main>
				...
				$query="SELECT NOMBRE,DESCRIPCION,PRECIOBASE,IVA,OID_PRODUCTO FROM PRODUCTOS WHERE CATEGORIA = 'OTROS'";
	...
	$_SESSION["paginacion"] = $paginacion;
		...
		header("Location: error_conexionBD.php");
			...
			<?php }	else { ?>
						...
						<a href="busquedaOtros.php?PAG_NUM=<?php echo $pagina; ?>&PAG_TAM=<?php echo $pag_tam; ?>"><?php echo $pagina; ?></a>

			<?php } ?>

		</div>
		
		<form method="get" action="busquedaOtros.php" class="formularioCambiarPagina">
